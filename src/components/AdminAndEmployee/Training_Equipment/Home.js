                                ...
                                resultData.slice(TableChangePageHome * TableChangeRowPerPageHome, TableChangePageHome * TableChangeRowPerPageHome + TableChangeRowPerPageHome)
                                    .map(value => (
                                        <TableRow key={value.trainingEquipment_id} component="tr">
                                            ...
                                            <TableCell
                                                component="td">{value.trainingEquipment_price.toLocaleString()}</TableCell>
            ...
            <List>
                <ListItem>
                    <ListItemText>
                        ...
                        {
                            resultStatus && resultStatus.result.map(data =>(
                                <Typography variant="subheading" style={styles.ListTypography}>
                                    <b>สถานะเครื่องเล่น{data.trainingEquipment_status}</b> จำนวน {data.countStatus} เครื่อง
                                </Typography>
                            ))
                        }
                    </ListItemText>
