...
const FormIncome = ({
    ...
    return (
        <div>
            <Dialog
                ...
                <DialogContent>
                    <DialogContentText>
                        ...
                        <FormControl component='p' margin="normal" required fullWidth>
                            <TextField label="รายละเอียด" value={incomeDetail} onChange={onChangeInput}
                                       name="incomeDetail"/>
                        </FormControl>
                        <FormControl component='p' margin="normal" required fullWidth>
                            <TextField
            ...
            {/* Day */}
            <Dialog
                open={isOpenDialogAddIncomeDay}
                onClose={onCloseDialogDay}
                TransitionComponent={Traisition}>
                <DialogTitle id="alert-dialog-slide-title">
                    เพิ่มรายการ: รายรับค่าสมาชิกรายวัน
                </DialogTitle>
                <Divider/>
                <DialogContent>
                    <DialogContentText>
                ...
                <DialogActions>
                    <Button color="primary" onClick={onCloseDialogDay}>
                        ยกเลิก
                    </Button>
                    <Button color="primary" onClick={onsubmitFormAddDay}>
                        ตกลง
                    </Button>
                </DialogActions>
            </Dialog>
